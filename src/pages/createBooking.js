    ...
    return <div className="createBookingPage">
        ...
        <div className="selectForm">
            ...
            <div className="selectDiv">
                <h4>Select a date:</h4>
                <select onChange={(event) => {
                    setMovieDateToPost({ ...movieDateToPost, day: new Date(event.target.value).toLocaleString('en-US', { day: "numeric" }), month: new Date(event.target.value).toLocaleString('en-US', { month: "numeric" }), year: new Date(event.target.value).toLocaleString('en-US', { year: "numeric" }), time: new Date(event.target.value).toLocaleString('en-US', { hour: '2-digit', minute: '2-digit' }) })
                    console.log(movieDateToPost);
                }}>
            ...
            <div className="selectDiv">
                ...
                <select onChange={(event) => {
                    ...
                    {movieDays.map((optiondata) => {
                        ...
                        console.log(movieSelectYear == dateyear && movieSelectMonth == datemonth && movieSelectDay == dateday)
